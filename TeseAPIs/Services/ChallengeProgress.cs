...
namespace TeseAPIs.Services
{
    ...
    {
        public async Task<ChallengeProgressData> CreateUpdateChallengeProgressById(ChallengeProgressData progressData, bool shouldUpdate)
        {
            ...
            {
                progressData.Credits = 0;
                progressData.FishCaught = 0;
